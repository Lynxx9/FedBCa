...
if __name__ == "__main__":
    ...
    Center2_preprocessing = True
    Center3_preprocessing = True
    Center4_preprocessing = True
    ...
    Center4_count = 0
    """Center_1 path """
    Center1_roi_root = r'/home/yuihsin/FedBCa/data/Center1/Annotation'
    Center1_data_root = r'/home/yuihsin/FedBCa/data/Center1/T2WI'
    Center1_roi_list = os.listdir(Center1_roi_root)
    Center1_save_root = r"/home/yuihsin/FedBCa/process_classification_v2/Center1"
    if not os.path.exists(Center1_save_root):
        os.makedirs(Center1_save_root)

    """Center_2 path """
    Center2_roi_root = r'/home/yuihsin/FedBCa/data/Center2/Annotation'
    Center2_data_root = r'/home/yuihsin/FedBCa/data/Center2/T2WI'
    Center2_save_root = r"/home/yuihsin/FedBCa/process_classification_v2/Center2"
    if not os.path.exists(Center2_save_root):
        os.makedirs(Center2_save_root)
    Center2_roi_list = os.listdir(Center2_roi_root)

    """Center_3 path """
    Center3_roi_root = r'/home/yuihsin/FedBCa/data/Center3/Annotation'
    Center3_data_root = r'/home/yuihsin/FedBCa/data/Center3/T2WI'
    Center3_save_root = r"/home/yuihsin/FedBCa/process_classification_v2/Center3"
    if not os.path.exists(Center3_save_root):
        os.makedirs(Center3_save_root)
    Center3_roi_list = os.listdir(Center3_roi_root)

    """Center_4 path """
    Center4_roi_root = r'/home/yuihsin/FedBCa/data/Center4/Annotation'
    Center4_data_root = r'/home/yuihsin/FedBCa/data/Center4/T2WI'
    Center4_save_root = r"/home/yuihsin/FedBCa/process_classification_v2/Center4"
    ...
    Center1_label_list = pd.read_excel(r'/home/yuihsin/FedBCa/data/Center1/Center1_label.xlsx')
    Center1_label_list = np.array(Center1_label_list)

    Center2_label_list = pd.read_excel(
        r'/home/yuihsin/FedBCa/data/Center2/Center2_label.xlsx')
    Center2_label_list = np.array(Center2_label_list)

    Center3_label_list = pd.read_excel(
        r'/home/yuihsin/FedBCa/data/Center3/Center3_label.xlsx')
    Center3_label_list = np.array(Center3_label_list)

    Center4_label_list = pd.read_excel(
        r'/home/yuihsin/FedBCa/data/Center4/Center4_label.xlsx')
    ...
    if Center1_preprocessing:
        ...
        Center1_all_information_pd.to_excel("/home/yuihsin/FedBCa/process_classification_v2/Center1/h5_information.xlsx")
    ...
    if Center2_preprocessing:
        ...
        Center2_all_information_pd.to_excel(
            "/home/yuihsin/FedBCa/process_classification_v2/Center2/h5_information.xlsx")
    ...
    if Center3_preprocessing:
        ...
        Center3_all_information_pd.to_excel(
            "/home/yuihsin/FedBCa/process_classification_v2/Center3/h5_information.xlsx")
    ...
    if Center4_preprocessing:
        ...
        Center4_all_information_pd.to_excel(
            "/home/yuihsin/FedBCa/process_classification_v2/Center4/h5_information.xlsx")
